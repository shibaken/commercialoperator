...
class ApplicationType(models.Model):
    ...
    application_fee = models.DecimalField('T Class Application Fee', max_digits=6, decimal_places=2)
    licence_fee_2mth = models.DecimalField('T Class Licence Fee (2 Months)', max_digits=6, decimal_places=2)
    licence_fee_1yr = models.DecimalField('T Class Licence Fee (1 Year)', max_digits=6, decimal_places=2)
